  ...
  let videos = [{
    ...
    let selectedVideo = videos.filter((item) => (
       ...
       let nodoDOM = selectedVideo.map((video) => {
          ...
          resultado += '<div class="card">  <div class="card-header">    <li>'+listaA+'</li>  </div>  <div class="card-body">    <h5 class="card-title">'+nombre+'</h5>    <p class="card-text text-center">'+previo+'</p> <p class="card-text">'+contenido+'</p>'+listaB+'  </div></div>';
